...
def getTweets(latitude, longitude, logger):
  ...
  try:
    ...
    returnMessage = "Found " + str(ctr) + " Tweets containing the word \"sick\" within 5 miles of your location! (Limiting results to 2 queries (200 tweets) due to Twitter rate limites)<br />Elapsed time: " + str(elapsedTime) + " seconds"
